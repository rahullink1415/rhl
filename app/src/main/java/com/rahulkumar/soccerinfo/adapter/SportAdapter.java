...
public class SportAdapter extends RecyclerView.Adapter<SportAdapter.MyViewHolder> {
    ...
    public SportAdapter(List<Country> dailyList, Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        Country data = sportList.get(position);
        holder.playerName.setText(data.getStrLeague());
        ...
        Glide.with(context).load(data.getStrLogo()).into(new ViewTarget<CircleImageView, Drawable>(holder.imageView) {
